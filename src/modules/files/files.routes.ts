...
import { studentBatchPresignedUrlSchema } from './files.validation.js';
...
studentRouter.post('/presigned-upload-urls', validateBody(studentBatchPresignedUrlSchema), controller.getStudentBatchPresignedUrls);
